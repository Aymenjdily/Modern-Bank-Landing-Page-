...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      ...
      <div className={`absolute top-0 w-[100%] h-[100%] rounded-full white__gradient z-[3] -left-1/2`}/>
      <div className={`absolute bottom-0 w-[100%] h-[50%] rounded-full pink__gradient z-[0] -left-1/2`}/>
    </div>
